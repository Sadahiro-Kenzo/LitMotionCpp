...
namespace LitMotionCpp
{
	...
	class MainLoopMotionScheduler :public IMotionScheduler<TValue,TOptions,TAdapter>
	{
	private:
		int m_loopTiming;
	...
	public:
		...
		{
			return MotionDispatcher::schedule<TValue, TOptions, TAdapter>(data, callbackData,m_loopTiming);
		}
